...
describe Canard::Abilities, "for guests" do
  ...
  context 'should not be able to' do
    it { cant([:accept_invitation, :read, :create, :destroy, :update, :manage], any(:user_group)) }
    ...
    it { cant([:default_group, :auto_complete, :create, :read, :destroy, :update, :manage], any(:user)) }
