...
ActiveRecord::Schema.define(version: 20160705162705) do
  ...
  add_index "user_payments", ["user_group_id"], name: "index_user_payments_on_user_id_and_user_group_id", unique: true, using: :btree
